...
INSERT INTO NTable(id_table) VALUES (1);
INSERT INTO NTable(id_table) VALUES (2);
...
create view ProduitTable as Select Ntable.id_table,Produit.id_produit,Produit.nom_produit,quantite,prix_produit,DetailsCommande.id_detailsCommande from Ntable join Commande on Commande.id_Table = NTable.id_table join DetailsCommande on DetailsCommande.id_commande = Commande.id_commande join Produit on Produit.id_produit = DetailsCommande.id_produit
